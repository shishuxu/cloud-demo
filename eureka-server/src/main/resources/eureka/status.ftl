...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body id="one">
              ...
              <tr>
                ...
                <td>
                  <#list app.instanceInfos as instanceInfo>
                    ...
                    <p>  <#if instance.isHref>
                        <a href="${instance.url}" target="_blank">${instance.id}</a>
                        <#if instanceInfo.isNotUp>
                          <button onclick="up('${app.name}', '${instance.id}');">UP</button>
                        <#else>
                          <button onclick="down('${app.name}', '${instance.id}');">DOWN</button>
                        </#if>
                        <button onclick="dlt('${app.name}', '${instance.id}');">DELETE</button>
                      <#else>
                        ${instance.id}
    ...
    <script type="text/javascript" src="eureka/js/akulaku.js" ></script>
